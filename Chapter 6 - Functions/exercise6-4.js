...
instead of printing them. Then, call the function 10 or more times in a loop, and
store the results in an array. Once the loop finishes, output the final array into
the console.
	...
	2. Create a loop that runs 10 times, incrementing by 1 each time, creating two
	 ...
	 3. Create a function that returns the value of the two parameters passed into
	    the function when it is called. Add the values together, returning the
		result.
	 ...
	 7. You should see the values [0, 6, 14, 24, 36,  50, 66, 84, 104, 126] for the
...
for (let i = 0; i < 10; i++) {
	let finalResult = calculate(i*5,i*i);
