...
let message = (`Your age is ${usersAge} - `);

if(usersAge >= 21){
    console.log(`${message} You can enter the venue and purchase alcohol.`);
} else if(usersAge >= 19 && usersAge < 21){
    console.log(`${message} You can enter the venue but cannot purchase alcohol`);
} else {
    console.log(`${message} You cannot enter the venue.`);
}